      ...
      <main className="container">
         <div>
            <div className="text-center mt-4 col-md-6 mx-auto ">
               <h1 className="text-dark">Proyecto de prueba con Bootstrap</h1>
                  ...
                  <div className="accordion-item">
                     ...
                     >
                        <div className="accordion-body">
                           ...
                           is shown by default, until the collapse plugin adds
                           ...
                           CSS or overriding our default variables. Also worth
